...
export const fetchUserDetails = createAsyncThunk(
  ...
  async (_, thunkAPI) => {
    try {
      const response = await axios.get(`${API_DOMAIN}/users/details`, {
...
export const editUserProfile = createAsyncThunk(
  ...
  async (data, thunkAPI) => {
    try {
      const response = await axios.post(`${API_DOMAIN}/users/edit`, data, {
        headers: getAuthHeaders(),
      });
      return response.data;
    } catch (error) {
...
export const addEditUserAddress = createAsyncThunk(
  ...
  async (data, thunkAPI) => {
    try {
      const response = await axios.post(`${API_DOMAIN}/users/address`, data, {
        headers: getAuthHeaders(),
      });
      // console.log(data);
      return response.data;
...
export const fetchUserAddresses = createAsyncThunk(
  ...
  async (_, thunkAPI) => {
    try {
      const response = await axios.get(`${API_DOMAIN}/users/addresses`, {
        headers: getAuthHeaders(),
      });
      // console.log(response.data);
      return response.data;
...
export const deleteUserAccount = createAsyncThunk(
  ...
  async (userId, thunkAPI) => {
    try {
      const response = await axios.post(`${API_DOMAIN}/users/delete`, userId, {
        headers: getAuthHeaders(),
      });
      return response.data;
    } catch (error) {
  ...
  async (addressId, thunkAPI) => {
    try {
      const response = await axios.post(
        `${API_DOMAIN}/users/address/delete`,
        { addressId },
        {
          headers: getAuthHeaders(),
        }
