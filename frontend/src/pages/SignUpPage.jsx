...
const SignUpPage = () => {
  ...
  return (
    <section id="sign-up" className="d-flex justify-content-center my-5">
      <div className="bg-white p-4 w-100 shadow" style={{ maxWidth: "400px" }}>
        ...
        <form onSubmit={submitHandler}>
          ...
          <button className="btn btn-pink mt-2 mb-4 w-100 rounded-0 ">
            Sign Up
          </button>
        </form>
        <p>
