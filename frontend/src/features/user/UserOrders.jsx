...
const UserOrders = () => {
  ...
  return (
    <div className="container-fluid pe-md-5 overflow-y-scroll" style={{ height: "calc(100vh - 1px)" }}>
      <div className="bg-white p-md-4 me-md-5">
                          ...
                          <div className="row gap-3 my-3" key={item?._id}>
                            ...
                            <div className="col ">
                              <div className="d-md-flex justify-content-end align-items-center d-grid gap-3">
                                <button
                                  onClick={() => {
                                    dispatch(addItemToCart({productId: item?._id, quantity: 1})).then(
                                      () => {
